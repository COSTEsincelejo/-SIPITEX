...
public class TrazabilidadControllerTests
{
    [Fact]
    public void TrazabilidadController_AdminInstructorYEncargado()
    {
        var classAttr = typeof(TrazabilidadController).GetCustomAttribute<AuthorizeAttribute>();
