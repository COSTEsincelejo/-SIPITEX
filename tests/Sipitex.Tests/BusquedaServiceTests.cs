...
public class BusquedaServiceTests
{
    ...
    public async Task SearchAsync_EncuentraMaterialPorNombre()
    {
        ...
        db.Materials.Add(new Material { Name = "Tela denim", Code = "mat-denim", Unit = MaterialUnit.Metros, Stock = 10, MinStock = 2, PlantaInventarioId = 1 });
        db.Materials.Add(new Material { Name = "Hilo blanco", Code = "mat-hilo", Unit = MaterialUnit.Unidades, Stock = 5, MinStock = 1, PlantaInventarioId = 1 });
