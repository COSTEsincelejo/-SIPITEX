...
using Sipitex.Application.Services; // NullAuditActorAccessor (seed / tests sin HTTP)
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IPlantaInventarioRepository, PlantaInventarioRepository>(); // Catálogo de plantasInventario (admin)
        ...
        services.AddScoped<IPrendaTrazableRepository, PrendaTrazableRepository>();
