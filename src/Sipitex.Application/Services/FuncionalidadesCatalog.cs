...
public static class FuncionalidadesCatalog
{
    ...
    [
        ...
        new("Inventario", "Consultar materiales",
            ...
            $"{UserRoles.Administrador}, {UserRoles.EncargadoDeBodega}, {UserRoles.Instructor}"),
        ...
        new("Inventario", "Registrar material",
            "Crea un material nuevo en planta de inventario (nombre, unidad, stock, origen de entrada).",
            $"{UserRoles.Administrador}, {UserRoles.EncargadoDeBodega} (+ permiso extendido)"),
        ...
        new("MRP / Materiales", "Consultar BOM",
            "Lista productos BOM (ficha técnica) y sus componentes. Instructor: solo las asignadas.",
            $"{UserRoles.Administrador}, {UserRoles.EncargadoDeBodega}, {UserRoles.Instructor}"),
        ...
        new("MRP / Materiales", "Crear / editar producto BOM",
            ...
            $"{UserRoles.Administrador}, {UserRoles.EncargadoDeBodega} (+ permiso extendido Mrp.GestionarFichas)"),
        ...
        new("Administración", "Asignar roles y permisos",
            "Define rol (Administrador/Instructor/EncargadoDeBodega), ficha, plantaInventario (si es EncargadoDeBodega) y permisos extendidos.",
            UserRoles.Administrador),
        new("Administración", "Gestionar plantasInventario",
            "Lista y crea plantasInventario físicas. Un encargadoDeBodega debe quedar asignado a una plantaInventario para ver su cola de solicitudes.",
            UserRoles.Administrador),
        new("Administración", "Consultar auditoría",
            "Bitácora de quién hizo qué en acciones críticas: usuarios (incl. plantasInventario asignadas), plantasInventario, órdenes de producción y ficha técnica BOM.",
            UserRoles.Administrador),
