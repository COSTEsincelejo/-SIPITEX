...
public static class AlertCatalog
{
    ...
    [
        (AlertType.StockBajo, "Stock bajo mínimo", "Materiales con stock por debajo del mínimo.", [UserRoles.Administrador, UserRoles.EncargadoBodega]),
        (AlertType.SolicitudPendiente, "Solicitudes pendientes", "Solicitudes de material sin aprobar/rechazar.", [UserRoles.Administrador, UserRoles.EncargadoBodega]),
        ...
        (AlertType.SolicitudMaterialNueva, "Nueva solicitud de materiales (ficha)", "Aviso inmediato al crear una SolicitudMaterial ligada a ficha.", [UserRoles.EncargadoBodega]),
