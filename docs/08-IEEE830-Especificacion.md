...
- Acordar el alcance entre instructores, plantaInventario, administración y el equipo de desarrollo.
...
| **Encargado de bodega** | Almacén | Stock, estado del material y aprobación de solicitudes |
...
| Caso de uso | Admin | Encargado de bodega | Instructor |
|-------------|:-----:|:---------:|:----------:|
| 1. Iniciar sesión | ✓ | ✓ | ✓ |
