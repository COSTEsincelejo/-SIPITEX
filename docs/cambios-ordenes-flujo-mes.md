...
## Objetivo
Extender el módulo de Órdenes con flujo de etapas tipo MES/ERP **sin romper** MRP, inventario de insumos, materiales de planta de inventario ni `AddProduction`.

## Análisis previo (resumen)
- `ProducedQuantity` + BOM/planta de inventario ya gestionan avance y stock de insumos.
...
- `Ordenes/Create`, `AddProduction`, materiales de planta de inventario, BOM snapshot, Fichas, Calidad: intactos.
